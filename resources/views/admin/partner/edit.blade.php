                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <input type="url" name="logo" placeholder="https://example.com/logo.svg" value="{{ old('logo', $partner->logo) }}" class="w-full rounded-lg border-gray-300">
                        </div>
                    </div>
                    <p class="text-xs text-gray-500 mt-1">Upload file (max 2MB) atau masukkan URL logo eksternal. Kosongkan untuk tetap menggunakan logo saat ini.</p>
