...
@section('title', 'Tambah Informasi Perusahaan - Admin')

@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Informasi Perusahaan</h1>
    <p class="text-gray-600 dark:text-gray-400 mt-1">Tambah informasi kontak perusahaan baru</p>
</div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="office_address" name="office_address" rows="3" required
                              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('office_address') }}</textarea>
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="map_embed" name="map_embed" rows="4"
                              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                              placeholder="Paste embed code dari Google Maps di sini">{{ old('map_embed') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center mt-1">
                        <input type="color" id="footer_bg_color" name="footer_bg_color"
                               ...
                               value="{{ old('footer_bg_color', '#000000') }}">
                ...
                <div>
                    ...
                    <div class="flex items-center mt-1">
                        <input type="color" id="footer_text_color" name="footer_text_color"
                               class="h-10 w-14 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 cursor-pointer"
                               value="{{ old('footer_text_color', '#ffffff') }}">
