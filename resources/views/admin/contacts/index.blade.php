...
@section('title', 'Hubungi Kami - Admin')

@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Pesan Masuk</h1>
    <p class="text-gray-600 dark:text-gray-400 mt-1">Kelola pesan yang masuk dari halaman kontak</p>
</div>
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                @forelse($contacts as $contact)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">{{ $contact->created_at->format('d/m/Y') }}</td>
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900 dark:text-white">{{ Str::limit($contact->subject, 30) }}</div>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Belum ada pesan masuk dari halaman kontak.</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
