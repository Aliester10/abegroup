...
@section('title', 'Add Sustainability')
...
<div class="px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex items-center mb-2">
            ...
            <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Add Sustainability</h1>
        </div>
        <p class="text-sm sm:text-base text-gray-600 mt-1 sm:mt-2">Create a new sustainability for homepage</p>
    </div>

    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('admin.sustainability.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="px-4 sm:px-6 py-4 sm:py-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div class="sm:col-span-2">
                        <label for="title" class="block text-sm sm:text-base font-medium text-gray-700 mb-1.5 sm:mb-2">
                            Title <span class="text-red-500">*</span>
                        </label>
                        <input type="text" 
                               id="title" 
                               name="title" 
                               value="{{ old('title', 'Komitmen Keberlanjutan') }}"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" 
                               id="subtitle" 
                               name="subtitle" 
                               value="{{ old('subtitle', 'Bertumbuh dengan tanggung jawab') }}"
                               class="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors text-sm sm:text-base"
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Upload gambar untuk sisi kanan section (JPEG, PNG, JPG, GIF - Max 2MB)</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="button_text" 
                               name="button_text" 
                               value="{{ old('button_text', 'Kolaborasi Bersama Kami') }}"
                               class="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors text-sm sm:text-base"
                ...
                <div id="points-container" class="space-y-3">
                    <div class="point-item">
                        <div class="flex items-center space-x-3">
                            <input type="text" 
                                   name="points[]" 
                                   value="{{ old('points.0', 'Efisiensi sumber daya dan pengelolaan risiko operasional') }}"
            ...
            <div class="px-6 py-6">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-xs text-gray-500 mt-1">Only active commitments will be displayed on the homepage</p>
                    </div>
                </div>
            </div>
