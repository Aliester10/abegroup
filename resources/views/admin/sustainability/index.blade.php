    ...
    <div class="flex justify-between items-center my-6">
        ...
        <a href="{{ route('admin.sustainability.create') }}" 
           class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-700 hover:bg-blue-800 focus:outline-none focus:shadow-outline-blue">
            <i class="fas fa-plus mr-2"></i> Add New Sustainability
        </a>
    </div>
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @forelse($commitments as $index => $commitment)
                        <tr class="text-gray-700 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-4 py-3">
                                <div class="text-sm font-semibold text-gray-800 dark:text-gray-300">{{ $commitment->title }}</div>
                            </td>
                            ...
                            <td class="px-4 py-3 text-sm text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="{{ route('admin.sustainability.edit', $commitment) }}" 
                                    ...
                                    <form action="{{ route('admin.sustainability.destroy', $commitment) }}" method="POST" class="inline">
                                        ...
                                        <button type="submit" 
                                                ...
                                                onclick="return confirm('Are you sure you want to delete this sustainability commitment?')" 
                                                title="Delete">
                        ...
                        <tr>
                            <td colspan="6" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p>No sustainability commitments yet.</p>
                                    <a href="{{ route('admin.sustainability.create') }}" class="mt-2 text-blue-600 hover:underline">Add one now</a>
                                </div>
                            </td>
                        </tr>
                    @endforelse
