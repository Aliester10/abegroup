...
<div class="px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center mb-2">
            ...
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Edit Nilai Inti</h1>
        </div>
        <p class="text-gray-600 mt-2">Edit prinsip yang menggerakkan ABE Group</p>
    </div>

    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('admin.core-values.update', $coreValue) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
